...
/* harmony import */ var _jquery_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./jquery.min.js */ "./resources/js/jquery.min.js");
...
/* harmony import */ var _jquery_dataTables_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jquery.dataTables.min.js */ "./resources/js/jquery.dataTables.min.js");
/* harmony import */ var _jquery_dataTables_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_jquery_dataTables_min_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _bootstrap_bundle_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bootstrap.bundle.min.js */ "./resources/js/bootstrap.bundle.min.js");
/* harmony import */ var _bootstrap_bundle_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_bootstrap_bundle_min_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _sb_admin_2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sb-admin-2 */ "./resources/js/sb-admin-2.js");
/* harmony import */ var _sb_admin_2__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_sb_admin_2__WEBPACK_IMPORTED_MODULE_3__);
/**
...
function MonthlyStaticticsHandaler() {
  ...
  var link = '/monthlyStatistics';
  var form = document.getElementById('MenthlyStatistics');
  form.action = link;
}

function remiHandaler(id) {
  $('#remiHand').modal('show');
  var link = '/hands/restore/' + id;
  var form = document.getElementById('remiForm');
  form.action = link;
}
...
if (document.getElementById('NewSituation') != null) {
  document.getElementById('NewSituation').addEventListener('change', function () {
    var situationSelector = document.getElementById('NewSituation');
    var situation = situationSelector.options[situationSelector.selectedIndex].value;
...
if (document.getElementById('motifSup') != null) {
  document.getElementById('motifSup').addEventListener('change', function () {
    var motifSelect = document.getElementById('motifSup');
    var motif = motifSelect.options[motifSelect.selectedIndex].value;
...
if (document.getElementById('PaieStatusHand') != null) {
  document.getElementById('PaieStatusHand').addEventListener('change', function () {
    var statusSelect = document.getElementById('PaieStatusHand');
...
__webpack_require__(/*! D:\Learning\GestionHand\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Learning\GestionHand\resources\sass\app.scss */"./resources/sass/app.scss");
