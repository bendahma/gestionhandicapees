...
<html lang="en">
  <head>
    ...
    <title>DASS AIN TEMOUCHENT</title>
    <style>
      a{
             ...
             <div class="card-body p-0">
                   <div class="p-3">
                     <div class="text-center">
                        <img src="{{asset('img/hand.png')}}" class="img-fluid" alt="">
                       <h2 class="h4 text-gray-900 mb-4" style="font-weight: 700">
                          مصلحة حماية الأشخاص المعوقين و ترقيتهم
                       </h2>
                     </div>   
                   </div>
             </div>
