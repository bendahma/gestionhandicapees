              ...
              <tbody>
                @foreach ($paie as $key => $p)
                    <tr>
                      ...
                      <td style="padding: 10px 0;font-size:0.9rem;">{{number_format($p->montantPaiement,2,'.',' ')}}</td>
                      <td style="padding: 10px 5px;font-size:0.9rem">{{number_format($p->montantAssurance,2,'.',' ')}}</td>
